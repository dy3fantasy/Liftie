...
class Storage {
    ...
    public void setMyExternalFile(Context ma){ myExternalFile = new File(ma.getExternalFilesDir(filepath), filename);}
     ...
     */
    public void export(Context appContext, Context ma)throws IOException{
    ...
    /**
     * METHODS THAT DEAL WITH EXTERNAL STORAGE
     */
